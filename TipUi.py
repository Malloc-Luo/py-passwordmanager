...
class TipUi(QDialog):
    ...
    def __init__(self, text: str, style=NORMAL, parent=None):
        ...
        self.setGeometry(QRect(int(desktop.width() / 2 - 75), int(desktop.height() * 0.83), 167, 70))
